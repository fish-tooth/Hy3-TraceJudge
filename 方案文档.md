# Hy3-TraceJudge：可验证数学推理过程评估与错误根因定位系统
...
>
> Existing evaluation often collapses mathematical reasoning into final-answer accuracy. Hy3-TraceJudge evaluates whether each conclusion is actually supported by the reasoning that precedes it.
>
